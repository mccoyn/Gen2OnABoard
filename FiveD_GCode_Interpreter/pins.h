...
#define Z_ENABLE_PIN (byte)19


//extruder pins
#define EXTRUDER_0_MOTOR_SPEED_PIN   (byte)28
...
#define EXTRUDER_0_STEP_ENABLE_PIN  (byte)0
...
#define EXTRUDER_1_TEMPERATURE_PIN  (byte)37 // Analogue input
#define EXTRUDER_1_VALVE_DIR_PIN    (byte)-1
#define EXTRUDER_1_VALVE_ENABLE_PIN (byte)-1 
#define EXTRUDER_1_STEP_ENABLE_PIN  (byte)-1 
